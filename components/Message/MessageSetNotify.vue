  ...
  methods: {
    async cheklogin () {
      ...
      if (localStorage.getItem('userInfoGoogle') !== null) {
        ...
        let check = localStorage.getItem('userInfoGoogle')
      ...
      if (localStorage.getItem('userInfoFacebook') !== null) {
        ...
        let check = localStorage.getItem('userInfoFacebook')
        switch (check) {
          case !null:
    ...
    async googleAuth () {
      try {
        ...
        // firebase
        //   .auth()
        //   .signInWithRedirect(this.providerGoogle)
        //   .then((result) => {
        //     let user = result.user
        //     localStorage.setItem('userInfoGoogle', JSON.stringify(user))
    ...
    async facebookAuth () {
      try {
        ...
        // firebase
        //   .auth()
        //   .signInWithRedirect(this.providerFacebook)
        //   .then((result) => {
        //     console.log(result)
        //     let token = result.credential.accessToken
        //     let user = result.user
        //     localStorage.setItem('userInfoFacebook', JSON.stringify(result.user))
        ...
        //   })
        //   .catch((err) => {
        //     console.log('fffff', err) // This will give you all the information needed to further debug any errors
        //   })
