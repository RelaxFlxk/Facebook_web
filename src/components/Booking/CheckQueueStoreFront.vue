<template>
  <v-main>
    ...
    :color="DarkModeBackground"
        ...
        <v-row v-if="$route.query.source === 'ohrich'">
          <v-col cols="6" class="text-right pl-10 pr-1">
            <v-btn
  ...
  async mounted () {
    if (this.$route.query.shopId) {
      ...
      if (this.$route.query.checkLine) {
        ...
        if (this.$route.query.source === 'ohrich') {
  ...
  methods: {
    ...
    async getProfile () {
      ...
      await this.$liff
        ...
        .then(async function (profile) {
          ...
          if (_this.$route.query.source === 'ohrich') {
            _this.checkMemberOhrich()
          }
        })
    ...
    async checkMemberOhrich () {
      ...
      await axios.get(this.DNS_IP + '/member/get?shopId=' + this.$route.query.shopId + '&liffUserId=' + this.profile.userId).then(async result => {
        ...
        await axios
          .post(this.DNS_IP + '/Booking/pushMsgQueue/' + this.$route.query.bookNo, dttt)
